  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className='w-[72px] h-full rounded-[20px] bg-[#4acd8d] flex justify-center items-center curspr-pointer'
        >
          <img
            src={search}
            alt='search'
      ...
      <div className='sm:hidden flex justify-between items-center relative'>
        ...
        <div
          className={`absolute top-[60px] left-0 right-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700`}
        >
          <ul className='mb-4'>
            {navlinks.map((link) => (
              <li
